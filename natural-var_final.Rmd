...
all_dates3 <- read.delim(file = "C:\\Users\\kmh\\Documents\\GitHub\\wytham-tits-fly\\all_dates3.txt", sep = ",") %>% distinct()
...
climate <- read.delim(file = "C:\\Users\\kmh\\Documents\\GitHub\\wytham-tits-fly\\climate_filled.csv", sep = ',')

climate$datetime <- as.POSIXct(climate$datetime, format = "%Y-%m-%d %H:%M:%S")

caught.hour.day <- read.delim(file = "C:\\Users\\kmh\\Documents\\GitHub\\wytham-tits-fly\\caught.hour.day.csv", sep = ',')
