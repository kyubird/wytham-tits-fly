...
all_dates3 <- read.delim(file = "C:\\Users\\kmh\\Documents\\DATA\\2022-4\\paper\\all_dates3.txt", sep = ",") %>% distinct()
...
#in the kyubird laptop
climate <- read.delim(file = "C:\\Users\\kmh\\Documents\\DATA\\2022-4\\paper\\climate_filled.csv", sep = ',')
...
#in the kyubird laptop
caught.hour.day <- read.delim(file = "C:\\Users\\kmh\\Documents\\DATA\\2022-4\\paper\\caught.hour.day.csv", sep = ',')
...
plot(acc.var, main = "individual repeatability for acc")
